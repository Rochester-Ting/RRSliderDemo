...
@interface RRLeftViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (strong, nonatomic) UITableView *tableView;
@end

@implementation RRLeftViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.RR_drawerController setupNewCenterViewController:new closeDrawer:NO finishHandler:^(BOOL finished) {
        NSLog(@"切换完成");
    }];
}
...
- (void)viewWillLayoutSubviews {
    CGRect frame = CGRectMake(0.0f, 64.0f, self.view.bounds.size.width, self.view.bounds.size.height - 200.0f);
